...
DATABASES = {
    'default': {
        ...
        'NAME': 'emredb-capstone', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'emredb-capstone.cxy3ownp500l.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'emre-capstone-1' # please enter your s3 bucket name
